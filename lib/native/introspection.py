...
"""
Native library functions for introspection.
...
def object_getattr(obj, name, default): pass
def isinstance(obj, cls): return True or False
def issubclass(obj, cls): return True or False
